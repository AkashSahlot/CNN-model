...
df= pd.read_excel(r"C:\Users\akashsahlot\Documents\yamnaya\Yamnaya Project File\cleaning_test2.xlsx")
df
...
x_valid,x_train=x_train_n[:228],x_train_n[228:]
y_valid,y_train=y_train_n[:228],y_train_n[228:]
x_test=x_test
...
model.add(keras.layers.Conv1D(32, 3, strides=1, padding='valid', activation='relu', input_shape=(x_train_n.shape[1],1))) # 1D convolutional layer with 32 filters, a kernel size of 3, and a ReLU activation function
...
future_data.to_excel("cnn_test2.xlsx", sheet_name='sheet1')
